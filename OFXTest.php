...
require_once '/Users/reubano/Documents/Projects/csv2ofx/OFX.php';

/**
 * Test class for OFX.
 * Generated by PHPUnit on 2012-11-17 at 11:54:14.
 */
class OFXTest extends PHPUnit_Framework_TestCase
{
    ...
    /**
     * Generated from @assert (array(array(array('Account Name' => 'account1'), array('Account Name' => 'account2')), array(array('Account Name' => 'account3'), array('Account Name' => 'account4')))) == array('account1', 'account3').
     *
    ...
    /**
     * Generated from @assert (array('cash', 'checking', 'unsavings'), array('Bank' => array('checking', 'savings'), 'Cash' => array('cash'))) == array('Cash', 'Bank', 'n/a').
     *
    ...
    public function testGetAccountTypes()
    {
        $this->assertEquals(
          array('Cash', 'Bank', 'n/a'),
          $this->object->getAccountTypes(array('cash', 'checking', 'unsavings'), array('Bank' => array('checking', 'savings'), 'Cash' => array('cash')))
        );
    }

    /**
     * Generated from @assert (array(array(array('Account Name' => 'account1', 'Amount' => 200), array('Account Name' => 'account1', 'Amount' => 200), array('Account Name' => 'account1', 'Amount' => 200))), array('account1')) == array(array(array('Account Name' => 'account1', 'Amount' => 600))).
     *
    ...
    {
        $this->assertEquals(
          array(array(array('Account Name' => 'account1', 'Amount' => 600))),
          $this->object->collapseSplits(array(array(array('Account Name' => 'account1', 'Amount' => 200), array('Account Name' => 'account1', 'Amount' => 200), array('Account Name' => 'account1', 'Amount' => 200))), array('account1'))
        );
    }
    ...
    /**
     * Generated from @assert (array('Transaction Type' => 'debit', 'Amount' => 1000.00, 'Description' => 'payee', 'Original Description' => 'description', 'Notes' => 'notes', 'Date' => '06/12/10', 'Category' => 'Checking', 'Account Name' => 'account'), 20120610111111) == array('amount' => '-1000', 'payee' => 'payee', 'desc' => 'description notes', 'id' => '370141bf77924d568817f7864c56419a', 'checkNum' => null, 'type' => 'debit', 'splitAccount' => 'Checking', 'splitAccountId' => '195917574edc9b6bbeb5be9785b6a479').
     *
    ...
    {
        $this->assertEquals(
          array('amount' => '-1000', 'payee' => 'payee', 'desc' => 'description notes', 'id' => '370141bf77924d568817f7864c56419a', 'checkNum' => null, 'type' => 'debit', 'splitAccount' => 'Checking', 'splitAccountId' => '195917574edc9b6bbeb5be9785b6a479'),
          $this->object->getTransactionData(array('Transaction Type' => 'debit', 'Amount' => 1000.00, 'Description' => 'payee', 'Original Description' => 'description', 'Notes' => 'notes', 'Date' => '06/12/10', 'Category' => 'Checking', 'Account Name' => 'account'), 20120610111111)
        );
    }
    ...
    public function testGetOFXTransactionHeader()
    {
        $this->assertEquals(
          "<OFX>\n\t<SIGNONMSGSRSV1>\n\t\t<SONRS>\n\t\t\t<STATUS>\n\t\t\t\t<CODE>0</CODE>\n\t\t\t\t<SEVERITY>INFO</SEVERITY>\n\t\t\t</STATUS>\n\t\t\t<DTSERVER>20120101111111</DTSERVER>\n\t\t\t<LANGUAGE>ENG</LANGUAGE>\n\t\t</SONRS>\n\t</SIGNONMSGSRSV1>\n\t<BANKMSGSRSV1><STMTTRNRS>\n\t\t<TRNUID>20120101111111</TRNUID>\n\t\t<STATUS><CODE>0</CODE><SEVERITY>INFO</SEVERITY></STATUS>\n",
          $this->object->getOFXTransactionHeader(20120101111111, 'ENG')
        );
    }
