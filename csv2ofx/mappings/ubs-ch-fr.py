...
mapping = {
    ...
    'class': lambda tr: tr['Description 1'] + (
        ': ' + tr['Description 2'] if tr['Description 2'] else ''
    ),
    ...
    'desc': lambda tr: (tr['Description 2'] or tr['Description 1']) + (
        ': ' + tr['Description 3'] if tr['Description 3'] else ''
    ),
    'payee': lambda tr:
        tr['Description 3'] if tr.get('Débit') != '' else tr['Description 2'],
