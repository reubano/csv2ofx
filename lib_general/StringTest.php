...
class StringTest extends PHPUnit_Framework_TestCase
    ...
    def testCsv2Array()
        assertEquals(
          ...
          object->csv2Array(array(0 => 'content,to,parse', 1 => 'content,to,parse'))
        )
    ...
    """
    def testExtraImplode()

        assertEquals(
          "'one' 'two'",
          object->extraImplode(array('one', 'two'))
        )
    ...
    """
    def testMakeLFLineEndings()

        assertEquals(
          "line one\nline two\nline three",
          object->makeLFLineEndings("line one\r\nline two\rline three")
        )
